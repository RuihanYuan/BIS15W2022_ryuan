...
flying_vec <- homerange %>%
  ...
  pull(common.name)#make a vector out of common name that can fly
```
...
ggVennDiagram(swim_aqua_carni_ecto_list, category.names = c("swim", "aquatic","carnivore", "ectotherm")#label=count,remove percentage)
```
