...
We can also select values in an entire column using the `$` sign. This can be useful for calculations. Here we calculate the mean of all of the birds weights. (call out column)
...
```
## [1] "/Users/lisayuan/Desktop/BIS15W2022_ryuan/lab3"
```
