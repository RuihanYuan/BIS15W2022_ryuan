...
It is a sequence of data that contains element of the same type.

2. What is a data matrix in R?  
The elements of the same data type arranged into a row by column form
...
```r
new_spring_matrix<-cbind(spring_matrix,mean_temperature)
new_spring_matrix
```
